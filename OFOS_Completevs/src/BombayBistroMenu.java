...
public class BombayBistroMenu {
    private static final Color MAIN_BG_COLOR = new Color(255, 153, 51); // Orange background
    private static final Color ACCENT_COLOR = new Color(75, 75, 75);   // Dark gray for text
    private static final Color BUTTON_COLOR = new Color(0, 102, 204);  // Blue accent color
    ...
    private static final String VADA_PAV_IMAGE_PATH = "C:\\Users\\pragu\\Downloads\\javapictures\\vadapav.jpg";
    private static final String PAV_BHAJI_IMAGE_PATH = "C:\\Users\\pragu\\Downloads\\javapictures\\download.jpeg";
    ...
    private static final String[] FOOD_INGREDIENTS = {
        "Spicy potato fritter (vada) sandwiched between buttered pav (bun), served with green chutney and crisp green chilies.",
        "Slow-cooked mixed vegetables simmered in spiced tomato-butter gravy, served with toasted pav and garnished with onions, lemon, and fresh coriander."
    };
    
    private static final double[] FOOD_PRICES = {50, 120};
    ...
    private static void createAndShowGUI() {
        ...
        mainFrame = new JFrame("Bombay Bistro - Menu");
        ...
        // Position the menu panel in the orange part of the background
    ...
    private static JPanel createHeaderPanel() {
        ...
        JLabel titleLabel = new JLabel("Bombay Bistro");
        titleLabel.setFont(HEADER_FONT);
        titleLabel.setForeground(ACCENT_COLOR);
        titleLabel.setAlignmentX(Component.LEFT_ALIGNMENT);
        
        JLabel subtitleLabel = new JLabel("Mumbai Street Food");
    ...
    private static JPanel createMenuPanel() {
        ...
        // Category header
        JLabel categoryLabel = new JLabel("Mumbai Street Food Classics");
        ...
        JPanel vadaPavPanel = createFoodItemPanel(
            FOOD_NAMES[0],
            FOOD_INGREDIENTS[0],
            FOOD_PRICES[0],
            VADA_PAV_IMAGE_PATH,
        ...
        JPanel pavBhajiPanel = createFoodItemPanel(
            FOOD_NAMES[1],
            FOOD_INGREDIENTS[1],
            FOOD_PRICES[1],
            PAV_BHAJI_IMAGE_PATH,
            1
        );
        
        foodGrid.add(vadaPavPanel);
        foodGrid.add(Box.createRigidArea(new Dimension(0, 15)));
        foodGrid.add(pavBhajiPanel);
    ...
    private static JPanel createFooterPanel() {
        ...
        JLabel infoLabel = new JLabel("Bombay Bistro • ★ 4.8 • 15-25 min delivery");
        ...
        JLabel copyrightLabel = new JLabel("© 2025 Mumbai Street Food App. All rights reserved.");
